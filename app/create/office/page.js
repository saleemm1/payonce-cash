...
const translations = {
  en: {
    title: "Sell Office Docs",
    docTitle: "Document Title",
    uploadLabel: "Main File (Word, Excel, PowerPoint)",
    seller: "Seller Name",
    email: "Support Email",
  ...
  ar: {
    title: "بيع مستندات أوفيس",
    docTitle: "عنوان المستند",
    uploadLabel: "الملف الرئيسي (وورد، إكسل، باوربوينت)",
    seller: "اسم البائع",
    email: "بريد الدعم",
  ...
  zh: {
    title: "出售办公文档",
    docTitle: "文档标题",
    uploadLabel: "主文件 (Word, Excel, PPT)",
    seller: "卖家名称",
    email: "支持邮箱",
  ...
  return (
    <div dir={dir} className={`min-h-screen bg-[#09090b] text-white flex flex-col items-center justify-center px-4 py-12 font-sans relative overflow-hidden ${lang === 'ar' ? 'font-arabic' : ''}`}>
      ...
      <form onSubmit={handleGenerate} className="relative z-10 w-full max-w-lg bg-[#18181b]/80 backdrop-blur-2xl p-8 rounded-3xl border border-white/5 shadow-2xl shadow-black/50 space-y-6 transform transition-all hover:border-white/10">
        ...
        <input required type="text" value={productName} onChange={(e) => setProductName(e.target.value)} className={inputBaseStyles} placeholder={t.docTitle} />
