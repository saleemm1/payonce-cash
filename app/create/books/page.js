  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white flex flex-col items-center justify-center px-6 py-10">
      <form onSubmit={handleGenerate} className="w-full max-w-md bg-[#18181b] p-8 rounded-2xl border border-white/10 shadow-2xl space-y-4">
        <h1 className="text-2xl font-bold mb-2 text-center text-green-500">Upload Digital Book</h1>
        ...
        <div>
          <label className="text-[10px] text-zinc-400 mb-1 block ml-1">E-Book File (.pdf, .epub, .mobi)</label>
          <input required type="file" accept=".pdf,.epub,.mobi" className="w-full p-2 bg-zinc-900 border border-zinc-700 rounded-lg text-sm text-gray-300 file:bg-green-600 mb-2" />
        </div>
        ...
        <div className="p-3 bg-zinc-800/30 rounded-lg border border-white/5">
          <label className="text-[10px] text-zinc-400 mb-2 block">Cover Image (Optional)</label>
        ...
        <div className="relative">
          <label className="text-[10px] text-zinc-400 mb-1 block font-bold italic">Rate: {bchPreview} BCH</label>
        ...
        <div className="bg-zinc-900/50 p-4 rounded-xl border border-dashed border-zinc-700 flex items-center justify-between">
          <div><h3 className="text-sm font-bold italic">Viral Mode</h3><p className="text-[10px] text-zinc-500">Enable 10% referral system</p></div>
        ...
        <button type="submit" className="w-full bg-green-600 hover:bg-green-500 py-4 rounded-xl font-bold transition-all uppercase">Generate Book Link</button>
        {generatedLink && (
