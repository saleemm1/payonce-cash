...
const translations = {
  en: {
    back: "Back to Home",
    title: "Sell Game Card",
    cardName: "Card Name (e.g. PSN $50)",
    assetFile: "Asset File",
    cardCode: "Card Code",
    uploadLabel: "Upload File",
    pasteCode: "Paste Game Codes here...",
    previewLabel: "Card Preview (File or URL) (Optional)",
    orUrl: "Or Image URL",
    seller: "Seller Name",
    email: "Support Email",
    rate: "BCH Rate:",
    ...
    generate: "Generate Card Link",
    processing: "Uploading Card...",
    copy: "Copy",
    done: "✅"
  },
  ar: {
    back: "العودة للرئيسية",
    title: "بيع بطاقة ألعاب",
    cardName: "اسم البطاقة (مثال: PSN $50)",
    assetFile: "ملف الأصل",
    cardCode: "كود البطاقة",
    uploadLabel: "رفع ملف",
    pasteCode: "الصق أكواد البطاقات هنا...",
    previewLabel: "معاينة البطاقة (ملف أو رابط) (اختياري)",
    ...
    generate: "إنشاء رابط البطاقة",
    processing: "جاري رفع البطاقة...",
    copy: "نسخ",
    done: "✅"
  },
  zh: {
    back: "返回首页",
    title: "出售游戏卡",
    cardName: "卡片名称 (如 PSN $50)",
    assetFile: "资产文件",
    cardCode: "卡代码",
    uploadLabel: "上传文件",
    pasteCode: "在此粘贴游戏代码...",
    previewLabel: "卡片预览 (文件或链接) (可选)",
    orUrl: "或图片链接",
    seller: "卖家名称",
    email: "支持邮箱",
    rate: "BCH 汇率:",
    ...
    <div dir={dir} className={`min-h-screen bg-[#09090b] text-white flex flex-col items-center justify-center px-4 py-12 font-sans relative overflow-hidden ${lang === 'ar' ? 'font-arabic' : ''}`}>
      ...
      <form onSubmit={handleGenerate} className="relative z-10 w-full max-w-lg bg-[#18181b]/80 backdrop-blur-2xl p-8 rounded-3xl border border-white/5 shadow-2xl shadow-black/50 space-y-6 transform transition-all hover:border-white/10">
        ...
        {deliveryType === 'file' ? (
          ...
          <textarea required value={textCode} onChange={(e)=>setTextCode(e.target.value)} placeholder={t.pasteCode} className={`${inputBaseStyles} h-32 resize-none`}></textarea>
        )}
