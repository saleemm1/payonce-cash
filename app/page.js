  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-green-500/30 font-sans overflow-x-hidden">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 border-b ${scrolled ? 'bg-[#050505]/80 backdrop-blur-md border-white/5 py-4' : 'bg-transparent border-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 items-center">
             ...
             <button onClick={scrollToFeatures} className="text-[11px] font-bold uppercase tracking-widest text-zinc-400 hover:text-white transition-colors">Features</button>
      ...
      <main className="flex flex-col items-center justify-center pt-40 pb-20 px-6 text-center relative">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter max-w-5xl mb-6 leading-[0.9] uppercase italic">
          <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-zinc-500">Monetize Your</span><br /> 
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600 drop-shadow-[0_0_15px_rgba(34,197,94,0.3)]">Digital Assets.</span>
        </h1>

        <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed font-medium">
          The first <span className="text-white">non-custodial</span> marketplace. Upload files, lock them with crypto, and sell instantly. No signup, no banks, no limits.
        </p>
        ...
        {/* Supported Assets Ticker (Visual Only) */}
      ...
      <section ref={howItWorksRef} className="py-32 px-6 border-t border-white/5 bg-[#08080a] relative">
         <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
               ...
               <h3 className="text-4xl md:text-5xl font-black uppercase italic text-white">From Upload to <span className="text-zinc-600">Cash</span></h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
               ...
               <div className="group relative bg-zinc-900/40 p-10 rounded-[40px] border border-white/5 hover:border-green-500/30 transition-all hover:-translate-y-2">
                  ...
                  <p className="text-zinc-500 text-sm leading-relaxed">Upload your file or paste your text. We encrypt it on IPFS. Only the buyer with the key can unlock it.</p>
               </div>
               ...
               <div className="group relative bg-zinc-900/40 p-10 rounded-[40px] border border-white/5 hover:border-green-500/30 transition-all hover:-translate-y-2">
                  ...
                  <div className="w-16 h-16 bg-zinc-800 rounded-2xl flex items-center justify-center text-3xl mb-8 group-hover:scale-110 transition-transform">🔗</div>
                  <h4 className="text-xl font-black uppercase italic mb-3">Set Price & Share</h4>
                  <p className="text-zinc-500 text-sm leading-relaxed">Set your price in USD (paid in BCH). Get a secure, shareable link to post on social media or send to clients.</p>
               </div>
               ...
               <div className="group relative bg-zinc-900/40 p-10 rounded-[40px] border border-white/5 hover:border-green-500/30 transition-all hover:-translate-y-2">
                  ...
                  <div className="w-16 h-16 bg-zinc-800 rounded-2xl flex items-center justify-center text-3xl mb-8 group-hover:scale-110 transition-transform">💰</div>
                  <h4 className="text-xl font-black uppercase italic mb-3">Get Paid Instantly</h4>
                  <p className="text-zinc-500 text-sm leading-relaxed">When they pay, funds go <span className="text-white font-bold">directly</span> to your wallet. No holding periods, no platform fees.</p>
               </div>
            </div>
         </div>
      </section>
      ...
      <section ref={featuresRef} className="py-32 px-6 relative overflow-hidden">
         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-green-600/5 blur-[100px] rounded-full pointer-events-none"></div>

         <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
            
            <div className="flex-1 text-left">
                <h2 className="text-green-500 text-sm font-black uppercase tracking-[5px] mb-3">Why PayOnce?</h2>
                <h3 className="text-4xl md:text-5xl font-black uppercase italic text-white mb-8 leading-tight">Built for the <br/>Sovereign Creator.</h3>
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h5 className="text-lg font-black uppercase italic mb-1">Uncensorable</h5>
                            <p className="text-zinc-500 text-sm max-w-sm">Data is stored on IPFS. Payments are on Blockchain. No one can ban your store.</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <section className="py-20 px-6">
         <div className="max-w-5xl mx-auto bg-gradient-to-r from-green-600 to-green-500 rounded-[50px] p-12 md:p-20 text-center relative overflow-hidden group">
            ...
            <div className="relative z-10">
                <h2 className="text-4xl md:text-6xl font-black text-black uppercase italic tracking-tighter mb-8 leading-none">
                    Ready to Own <br/> Your Economy?
                </h2>
                <Link href="/create">
